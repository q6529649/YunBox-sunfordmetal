...
jQuery(function($) {
	...
	$('#bk_1').hover(
		function () {
			$('#bk_sy_1').animate({left:'40%',opacity:1},300);
			biankuang(1);
		},
		function () {
            $('#bk_sy_1').animate({left:'10%',opacity:0},300);
			biankuang1(1);
		}
	);
	$('#bk_2').hover(
		function () {
			$('#bk_sy_2').animate({left:'40%',opacity:1},300);
			biankuang(2);
		},
		function () {
            $('#bk_sy_2').animate({left:'10%',opacity:0},300);
			biankuang1(2);
		}
	);
	$('#bk_3').hover(
		function () {
			$('#bk_sy_3').animate({left:'40%',opacity:1},300);
			biankuang(3);
		},
		function () {
            $('#bk_sy_3').animate({left:'10%',opacity:0},300);
			biankuang1(3);
		}
	);
	$('#bk_4').hover(
		function () {
			$('#bk_sy_4').animate({left:'40%',opacity:1},300);
			biankuang(4);
		},
		function () {
            $('#bk_sy_4').animate({left:'10%',opacity:0},300);
			biankuang1(4);
		}
	);
	$('#bk_5').hover(
		function () {
			$('#bk_sy_5').animate({left:'40%',opacity:1},300);
			biankuang(5);
		},
		function () {
            $('#bk_sy_5').animate({left:'10%',opacity:0},300);
			biankuang1(5);
		}
	);
})
